...
function usage () {
    echoBold "This script automates the installation of WSO2 API Manager pattern 3 Kubernetes resources\n"
...
${KUBECTL} create configmap apim-is-km-conf --from-file=../confs/is-as-km/
${KUBECTL} create configmap apim-is-km-conf-axis2 --from-file=../confs/is-as-km/axis2/
${KUBECTL} create configmap apim-is-km-conf-datasources --from-file=../confs/is-as-km/datasources/
...
${KUBECTL} create configmap apim-gateway-conf --from-file=../confs/apim-gw/
${KUBECTL} create configmap apim-gateway-conf-axis2 --from-file=../confs/apim-gw/axis2/
...
${KUBECTL} create -f ../apim-gateway/wso2apim-gateway-service.yaml
...
${KUBECTL} create -f ../apim-gateway/wso2apim-gateway-volume-claim.yaml
${KUBECTL} create -f ../apim-gateway/wso2apim-gateway-deployment.yaml
sleep 2m
...
${KUBECTL} create -f ../ingresses/wso2apim-is-as-km-ingress.yaml
